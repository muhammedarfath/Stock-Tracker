...
function Cards() {
  return (
    <div className='grid grid-cols-4 gap-4 mt-[5rem] p-4 shadow-2xl shadow-black backdrop-blur-lg'>
    {Array(8).fill().map((_, i) => (
      <div key={i} className="max-w-sm p-6 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-black backdrop-blur-lg">
